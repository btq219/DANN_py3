...
source_dataset_root = os.path.join('dataset/8positions_200/features_shuffle/', source_dataset_name)
target_dataset_root = os.path.join('dataset/8positions_200/features_shuffle/', target_dataset_name)
